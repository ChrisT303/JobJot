...
<main>
  <div class=" mx-auto  my-4">
    ...
    <div className="min-h-screen grid md:grid-cols-2 gap-x-3rem max-w-full" style={{ gridTemplateRows: 'calc(var(--nav-height) + 3rem) 1fr' }}>
      <div className="mx-4 sm:mx-6 md:mx-8 flex justify-center items-center md:items-start flex-col">
